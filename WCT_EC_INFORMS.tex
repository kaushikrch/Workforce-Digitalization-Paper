...
\textbf{Basin-of-attraction map.} Grid: $W_0 \in \{0.08, 0.10, \ldots, 0.80\}$, $F \in \{0.70, 0.75, \ldots, 1.95\}$ ($37{\times}26$ trajectories). Doubled-grid validation ($73{\times}51$) shifts the separatrix by at most $0.0075$ $W_0$-units. Burnout Cliff collapse criterion: $T(t{=}500) < 0.15$.
