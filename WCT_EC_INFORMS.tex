...
Trustpilot (1--5, complaint-biased); Glassdoor (1--5); Yahoo Finance (\texttt{yfinance}); UK ONS internet sales (J4MC); Eurostat (\texttt{isoc\_ec\_eseln2}).

\textit{Variables.}
$K{=}$CapEx/Revenue; $W{=}$Glassdoor overall; $T{=}$ACSI or Trustpilot (rescaled: $(s{-}1){\times}25$); $K{\times}W{=}$standardised interaction; Assets rank${=}$within-year percentile (currency-neutral).
