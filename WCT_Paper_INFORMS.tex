...
\bottomrule
\end{tabular}
}}{Dependent variable: $\ln E_{ct} - \ln E_{c,2015}$ (log employment growth relative to 2015 baseline). Standard errors clustered at county level in parentheses. $^{***}p < 0.01$; $^{**}p < 0.05$. $\text{Ecom}_t$ main effect absorbed by year FE (national variable); $W^z_{c,2015}$ absorbed by county FE (time-invariant). Column (2): excludes 2020--2021. Columns (3)--(4): split at median baseline employment. Column (5): 2015--2017 only (pre-period placebo; 24 county-year observations dropped due to missing BLS data in 2015--2017).}\end{table}
