...
\bottomrule
\end{tabular}
}}{CapEx/Revenue reports the median (with range) rather than the mean due to extreme outliers in the raw ratio (e.g., BBY 2012); the mean and SD are not representative for this variable.}
\end{table}
